...
*****************************************************************************************/
BOOL sjx::CMD5Checksum::GetMD5(const CString& strFilePath, CString& csMD5)
{
	try
	{
		CFile file;
...
*****************************************************************************************/
DWORD sjx::CMD5Checksum::RotateLeft(DWORD x, int n)
{
...
NOTES:   None
*****************************************************************************************/
void sjx::CMD5Checksum::FF(DWORD& A, DWORD B, DWORD C, DWORD D, DWORD X, DWORD S, DWORD T)
{
	DWORD F = (B & C) | (~B & D);
	A += F + X + T;
	A = RotateLeft(A, S);
...
NOTES:   None
*****************************************************************************************/
void sjx::CMD5Checksum::GG(DWORD& A, DWORD B, DWORD C, DWORD D, DWORD X, DWORD S, DWORD T)
{
	DWORD G = (B & D) | (C & ~D);
	A += G + X + T;
	A = RotateLeft(A, S);
...
NOTES:   None
*****************************************************************************************/
void sjx::CMD5Checksum::HH(DWORD& A, DWORD B, DWORD C, DWORD D, DWORD X, DWORD S, DWORD T)
{
	DWORD H = (B ^ C ^ D);
	A += H + X + T;
	A = RotateLeft(A, S);
...
NOTES:   None
*****************************************************************************************/
void sjx::CMD5Checksum::II(DWORD& A, DWORD B, DWORD C, DWORD D, DWORD X, DWORD S, DWORD T)
{
	DWORD I = (C ^ (B | ~D));
	A += I + X + T;
	A = RotateLeft(A, S);
...
*****************************************************************************************/
void sjx::CMD5Checksum::ByteToDWord(DWORD* Output, BYTE* Input, UINT nLength)
{
	//entry invariants  
	ASSERT(nLength % 4 == 0);
...
*****************************************************************************************/
void sjx::CMD5Checksum::Transform(BYTE Block[64])
{
...
*****************************************************************************************/
void sjx::CMD5Checksum::DWordToByte(BYTE* Output, DWORD* Input, UINT nLength)
{
	//entry invariants  
	ASSERT(nLength % 4 == 0);
...
*****************************************************************************************/
CString sjx::CMD5Checksum::Final()
{
	//Save number of bits  
	BYTE Bits[8];
...
*****************************************************************************************/
void sjx::CMD5Checksum::Update(BYTE* Input, ULONG nInputLen)
{
...
BOOL sjx::CMD5Checksum::GetMD5OfString(CString strString, CString& csMD5)
{
	try
	{
		CMD5Checksum MD5Checksum;   //checksum object   
